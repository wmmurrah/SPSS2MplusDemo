...
GET
  FILE='C:\Dropbox\3_Teaching\SPSS2MplusDemo\data\star.sav'.
DATASET NAME DataSet1 WINDOW=FRONT.

*Save a copy of the original file to perform transformation on. 
* This way you always have an original copy of the data.

SAVE OUTFILE='C:\Dropbox\3_Teaching\SPSS2MplusDemo\data\star2012.12.17.sav'
  /COMPRESSED.
...
GET
  FILE='C:\Dropbox\3_Teaching\SPSS2MplusDemo\data\star2012.12.17.sav'.
...
RECODE ethnicity ("afam"=1) ("hispanic"=1) (MISSING=SYSMIS) (ELSE=0) INTO other.
EXECUTE.
...
RECODE childid TO other (missing = -99).
MISSING VALUES childId TO other (-99).
execute.

************************** STEP 5 **************** 
save SPSS file as a tab delimited (.dat) file.

SAVE TRANSLATE OUTFILE='C:\Dropbox\3_Teaching\SPSS2MplusDemo\data\starMplus.dat'
  /TYPE=TAB
  /MAP
  /REPLACE
  /CELLS=VALUES.
